...
const FileUploadComponent = ({ onFileSelect, label }) => {
    ...
    // This component only displays the upload area, not the selected file.
    // The parent component will manage displaying the selected file if needed.
    return (
